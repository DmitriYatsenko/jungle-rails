...
RSpec.describe User, type: :model do
    before do
        @newUser = User.new(:first_name => "Elmer", :email => "ElMER@elmermail.com", :password => "elmer4you", :password_confirmation => "elmer4you")
        @newUser.save
        @newUser_EmailCheck = User.new(:first_name => "Elmer", :email => "elmer@elmermail.com", :password => "elmer4you", :password_confirmation => "elmer4you")
    end
    describe 'User Validations' do
        it 'should have all fields' do
            expect(@newUser.first_name).to be_present
